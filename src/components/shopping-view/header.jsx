        ...
        <div className="relative">
          ...
          >
            ...
            {cartItems && cartItems.items && cartItems.items.length > 0 && (
              <div className="absolute top-[-8px] right-0 text-sm bg-red-500 w-4 h-4 rounded-full text-white flex items-center justify-center">
  ...
  return (
    ...
    >
      <div className="flex h-16  items-center justify-between px-4 md:px-6">
        ...
        <div className="flex">
          {isAuthenticated && <div className="">{<HeaderRightContent />}</div>}
        </div>
      </div>
    </header>
  );
